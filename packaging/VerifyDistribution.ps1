...
$projectPath = Join-Path $repositoryRoot 'Icod.DirTree.csproj'
$solutionPath = Join-Path $repositoryRoot 'Icod.DirTree.sln'
...
try {
    ...
    Assert-ToolPackage `
        ...
        -ExpectedCommand 'dirtree' `
        -RequiredAssemblies @('dirtree.dll')
    ...
    $toolShim = Get-ExecutablePath -Directory $toolPath -CommandName 'dirtree'
